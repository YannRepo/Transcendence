...
const avatar_module_1 = require("./user/avatar.module");
const avatar_service_1 = require("./user/avatar.service");
let AuthModule = exports.AuthModule = class AuthModule {
};
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        imports: [jwt_1.JwtModule.register({}), user_module_1.UserModule, avatar_module_1.AvatarModule],
